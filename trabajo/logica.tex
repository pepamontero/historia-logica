...
POSIBLE REESTRUCTURACIÓN: POR SIGLOS EN VEZ DE situaciones

SIGLO VI: traducción de Boecio al latín
SIGLO VII: se reduce el interés de la lógica en Europa. Sin embargo, se empieza a traducir las obras de aristóteles al árabe.
SIGLO VIII: aparece la casa de la sabiduria en Baghdad
SIGLO IX: el interés por la lógica sigue siendo mínimo, con el imperio carolingio renace un interés, se configura un plan de lógica en el curriculo pero no hay innovaciones
SIGLO X: Alfarabi, Avicenna
SIGLO XI: se empieza a reintroducir la lógica en Europa mediante las traducciones del árabe al latín (obras de Averroes)
siglo XII: renacimiento por completo de la lógica
