...
Esta tradición hebrea de las obras de Averroes influyó en la tradición latina a partir de finales del siglo XV, cuando textos hebreos de obras árabes comenzaron a ser traducidos al latín. La culminación de este proceso se representa en la edición más elaborada y "definitiva" de las obras de Aristóteles en latín, impresa por primera vez por los hermanos Giunta en Venecia entre 1550 y 1552, y reimpresa varias veces después\cite{charles2004latin}.
